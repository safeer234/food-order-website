  ...
  return (
    <div>
      ...
      <div className='flex justify-center gap-90'>
        <div className='ml-80 md:ml-80 lg:ml-0'>
          <div>
          ...
          <div className='block md:block lg:flex py-8 gap-6 items-center ml-8 md:ml-19 lg:ml-0'>
            <div>
              <p className=' text-xl md:text-2xl lg:text-2xl text-[#57534e] font-medium'>Fast Delivery</p>
          ...
          <div className='block md:block lg:flex py-8 gap-10 items-center ml-8 md:ml-19 lg:ml-0'>
            <div>
              <p className='text-xl md:text-2xl lg:text-2xl text-[#57534e] font-medium'>Fresh Food</p>
          ...
          <div className='block md:block lg:flex w-40 lg:w-60 py-8 gap-6 items-center ml-8 md:ml-19 lg:ml-0'>
            <div>
              <p className='text-xl md:text-2xl lg:text-2xl text-[#57534e] font-medium'>Free Delivery</p>
