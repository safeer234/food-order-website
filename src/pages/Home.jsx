            ...
            <div className='block sm:block md:block lg:flex gap-40 w-90 sm:w-90 md:w-150 lg:w-360 px-5 sm:px-5 md:px-10 lg:px-16 ml-2 sm:ml-3 md:ml-20 lg:ml-10 h-90 sm:h-90 md:h-100 lg:h-34 py-0.5 sm:py-0.5 md:py-10 lg:py-2  shadow-2xl bg-[#ffedd5] rounded-2xl '>
                <div className='flex gap-7'>
                    ...
                    <div>
                        ...
                        <p className='text-[#57534e]'>The food will be delivered to<br />your home within 1-2 hours of<br />your ordering</p>
                ...
                <div className='flex gap-7'>
                    ...
                    <div>
                        ...
                        <p className='text-[#57534e]'>Your food will be delivered<br />100% fresh to your home, we<br />do not deliver stale food</p>
                ...
                <div className='flex gap-7'>
                    ...
                    <div>
                        ...
                        <p className='text-[#57534e]'>Your food delivery is<br /> absolutely free of cost<br />just order and enjoy</p>
