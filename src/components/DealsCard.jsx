  ...
  return (
    <div>
      ...
      <div className='flex gap-41 px-4 py-3'>
         <p>{prop.deal.price}</p>
      <button onClick={()=> dispatch(addFood(prop.deal))} className=' cursor-pointer duration-200 ease-in hover:bg-[#fca5a5] text-center bg-[#ef4444] text-[white] p-1 rounded-lg w-30'>Add</button>
